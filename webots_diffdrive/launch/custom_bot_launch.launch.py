...
def _make_robot_def(i, y_pos):
    ...
    return (
        ...
        f'    Camera {{\n'
        f'      name "camera"\n'
        f'      translation 0.05 0 0.1\n'
        f'      width 640\n'
        f'      height 480\n'
        f'      children [\n'
        f'        Shape {{\n'
        f'          appearance PBRAppearance {{ baseColor 1 0 0 }}\n'
        f'          geometry Box {{ size 0.02 0.05 0.02 }}\n'
        f'        }}\n'
        f'      ]\n'
        f'    }}\n'
        f'  ]\n'
...
def launch_setup(context, *args, **kwargs):
    ...
    urdf_template = os.path.join(package_dir, 'resource', 'urdf_camera.urdf')
